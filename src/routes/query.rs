...
//     let response = send_request(&params.query, &params.doc, client.clone()).await;
...
//         params.query,
//         json.len(),
//         json.first().map_or_else(|| 0.0, |data| data.ranking_score.unwrap_or(0.0)),
//         json.last().map_or_else(|| 0.0, |data| data.ranking_score.unwrap_or(0.0)),
